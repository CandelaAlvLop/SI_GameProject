Project Pizza Game 3D - Interactive System
...
Furthermore, for the floor that represents the table where the pizza has to be created, we have used textures obtained from the Asset Store from the package https://assetstore.unity.com/packages/3d/props/wooden-pbr-table-112005.
